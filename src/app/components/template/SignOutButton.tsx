...
export default function SignOutButton() {
    return (
        <div className="hidden h-auto w-full grow rounded-md bg-gray-50 md:block items-center">
                <button
                    className="flex h-[48px] grow items-center justify-center gap-2 rounded-md bg-gray-500 p-3 text-sm font-medium hover:bg-sky-100 hover:text-blue-600 md:flex-none md:justify-start md:p-2 md:px-3"
